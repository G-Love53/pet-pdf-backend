# Pet Service Insurance Direct — Instantly email creatives

Hosted on **petserviceinsurancedirect.com** via `pet-pdf-backend/Netlify/email/`.
...
| **JPEG** | `CID_Pet_Creative.jpg` |
| **Instantly HTML** | `instantly_step3.html` |
| **Public JPEG URL** | https://petserviceinsurancedirect.com/email/archive/2026-08-connect-v1/CID_Pet_Creative.jpg |
...
node scripts/generate-instantly-email.mjs --segment pet --version 2026-08-connect-v1
node scripts/extract-creative-jpg.mjs \
  --input ~/Downloads/CID_Creative_Pet_Embedded.html \
  --output ~/GitHub/pet-pdf-backend/Netlify/email/archive/2026-08-connect-v1/CID_Pet_Creative.jpg
```
